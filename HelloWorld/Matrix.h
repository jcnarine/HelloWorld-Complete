...
public:
	...
	//*useful for grabbing rotation matrix from a homogenous transformation matrix
	mat3(mat4 m);

	//output information
	void Print();
	//Adds from the current mat2
	void Add(mat3 m);
